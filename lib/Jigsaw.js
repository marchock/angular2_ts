        ...
        this.Utils = function (s) {
            ...
            return {
                getWidth: function () {
                    ...
                    // document.querySelector(Settings.classnames.container)
                    // check if the container still exist or an error will occur when leaving the page
                    if (Settings.classnames.container && document.querySelector(Settings.classnames.container)) {
